...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.Title = field.NewString(tableName, "title")
	_order.UserID = field.NewInt64(tableName, "user_id")
	_order.PayeeID = field.NewInt64(tableName, "payee_id")
	_order.Status = field.NewInt64(tableName, "status")
	_order.Updated = field.NewInt64(tableName, "updated")
	_order.Created = field.NewInt64(tableName, "created")
	_order.Deleted = field.NewInt64(tableName, "deleted")
...
func (o *order) updateTableName(table string) *order {
	...
	o.PayeeID = field.NewInt64(table, "payee_id")
	o.Status = field.NewInt64(table, "status")
	o.Updated = field.NewInt64(table, "updated")
	o.Created = field.NewInt64(table, "created")
	o.Deleted = field.NewInt64(table, "deleted")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["updated"] = o.Updated
	o.fieldMap["created"] = o.Created
